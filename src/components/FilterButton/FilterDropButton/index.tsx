  ...
  return (
    <div>
      <button
        ...
        className='sm:w-[16rem] w-[10.7rem] py-[1rem] px-[2rem] md:py-[1.6rem] rounded-[1.5rem] border text-[#0B3B2D] dark:text-gray-10 text-[1.8rem] font-[500] bg-[#FFFFFF] dark:bg-nomad-black border-[#0B3B2D] flex items-center justify-between'
      >
        {text}
