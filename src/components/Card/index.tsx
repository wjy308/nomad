...
export default function Card({ image, children }: Props) {
  return (
    <div className='rounded-[1.2rem] max-w-[79.2rem] bg-white w-full flex gap-x-[2.4rem] h-[20.4rem] max-lg:h-[15.6rem] max-md:h-[12.8rem] max-lg:gap-x-[1.2rem] max-md:gap-x-[0.8rem]'>
