...
export default function MyReservationCardInfo({
  ...
  const btnCss = 'w-[8rem] md:w-[12.1rem] h-[4rem] md:text-[1.4rem] text-[1.2rem] font-[700]';
  ...
  return (
    <>
      <div className='relative flex flex-col justify-center w-full'>
        <span className={`leading-[2.6rem] font-[700] md:text-[1.6rem] text-[1.4rem] ${statusInfo.btnColor}`}>{statusInfo.name}</span>
        <h3 className='md:text-[2rem] text-[1.4rem] dark:text-gray-10 font-[700] md:leading-[2.6rem] leading-[2.4rem] text-[#112211] lg:mt-[0.8rem]'>{activity.title}</h3>
        <span className='md:text-[1.8rem] text-[1.2rem] dark:text-gray-10 font-[400] md:leading-[2.4rem] leading-[1.8rem] lg:pt-[1.2rem] md:pt-[0.5rem]'>
          {date} · {startTime} - {endTime} · {headCount}명
        </span>
        <div className='flex justify-between items-center mt-[1.6rem] lg:mt-[1rem]'>
          <span className='md:text-[2.4rem] text-[1.6rem] text-[#1b1b1b] dark:text-gray-10 md:leading-[2.864rem] leading-[2.6rem] font-[500]'>
            {'\uFFE6'}
