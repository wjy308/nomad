  ...
  return (
    <ul className='flex flex-col w-full gap-[0.8rem]'>
      {SIDE_NAV_OPTIONS.map((item) => (
        <li className={`rounded-[1.2rem] hover:bg-[#CED8D5] dark:hover:bg-[#CED8D5] group ${router.pathname === item.linkUrl ? 'bg-[#CED8D5]' : 'bg-[#FFFFFF] dark:bg-nomad-black'}`} key={item.id}>
