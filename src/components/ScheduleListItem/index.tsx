...
export default function ScheduleListItem({ schedule, delSchedule }: { schedule: Schedule; delSchedule: () => void }) {
  ...
  return (
    <div className='flex'>
      ...
      <button type='button' onClick={delSchedule} className='relative flex-shrink-0 w-[5.6rem] h-[5.6rem] max-md:w-[4.4rem] max-md:h-[4.4rem]'>
