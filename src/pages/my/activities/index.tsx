...
export default function MyActivities() {
  ...
  return (
    <MyLayout>
      <main className='bg-gray-10 mb-[12rem] min-h-[81rem] max-md:min-h-[67rem]'>
        <div className='flex justify-between mb-[2.4rem]'>
          ...
          <Link
            ...
            className='flex justify-center items-center w-[12rem] h-[4.8rem] text-[#fff] bg-nomad-black font-bold text-[1.6rem] leading-[2.6rem] rounded-[0.4rem]'
          >
            체험 등록하기
          </Link>
        </div>
